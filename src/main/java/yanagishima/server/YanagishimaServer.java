...
import org.mortbay.servlet.GzipFilter;import org.mortbay.servlet.GzipFilter;
...
public class YanagishimaServer {
	...
	public static void main(String[] args) throws Exception {
		...
		servletContextHandler.addFilter(new FilterHolder(GzipFilter.class), "/static/*", EnumSet.of(DispatcherType.REQUEST));
